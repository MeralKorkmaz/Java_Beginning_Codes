...
2)Learn and explain HashMap Mechanism
    ...
    vi)If "75%" of  the existing buckets is full Java creates a new 16 buckets after that it starts to divide 32
    v)To find an entry Java follows the following steps
        Bucket --> HashCode --> Key --> return value (after dividing 16, look for the bucket)
 */
