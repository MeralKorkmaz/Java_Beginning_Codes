...
public class C03MultiDimensionalArrays {
    ...
    public static void main(String[] args) {
        ...
        //how many member they have

        //How to write multidimensional Array on the console
        System.out.println(Arrays.deepToString(numbers));//[[0, 0], [0, 0], [0, 0]]
        //toString just printing one deepToString multiple
        ...
        int numOfElements = 0;
        for(String[] w:arr){//the data type is array,it contains String. So, it is String []
