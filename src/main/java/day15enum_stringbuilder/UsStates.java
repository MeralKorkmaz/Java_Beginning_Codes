...
//California's name, abb and capital is not change. It is constant. So, we are using final

   UsStates(String stateName,String abbreviation,String capital){
       this.stateName = stateName; //pink one belongs to enum and the other will come from another class
       this.abbreviation = abbreviation;
       this.capital = capital;
   }

    public String getStateName() {//method
        return stateName;
    }
